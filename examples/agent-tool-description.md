...
- Foreground vs background: background is the default — agents run without blocking and notify you on completion. Set run_in_background: false only when you must block and get the result before proceeding.
