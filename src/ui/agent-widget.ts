...
export function buildInvocationTags(
  ...
  if (invocation.contextMode && invocation.contextMode !== "fresh") tags.push(`context: ${invocation.contextMode}`);
  else if (invocation.inheritContext) tags.push("inherit context");
